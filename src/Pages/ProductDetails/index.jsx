...
const ProductDetails = () => {
  ...
  const goToReviews = () => {
    window.scrollTo({
      top: reviewRef.current.offsetTop - 170,
      behavior: "smooth",
    });
    setActiveTab(2);
  };
        ...
        <section className="bg-white py-5">
          ...
          <div className="container pt-10" ref={reviewRef}>
            <div className="flex items-center gap-4 lg:gap-8  mb-3 lg:mb-5">
              <span
                className={`  text-[15px] lg:ext-[17px] cursor-pointer font-[500] transition-colors duration-300 ease-in-out px-3 py-1 rounded-full
              ...
              <span
                className={` text-[15px] lg:text-[17px] cursor-pointer font-[500] transition-colors duration-300 ease-in-out px-3 py-1 rounded-full
                 ${activeTab === 2 && "text-white bg-primary  "} `}
                ...
                <div className="w-full productReviewContainer">
                      ...
                      [...product?.reviews].reverse().map((review) => (
                        <div className="review py-5 lg:pr-5 border-b border-[rgba(0,0,0,0.2)] w-full flex items-center justify-between">
                          <div className="info w-[60%] flex items-center gap-3 ">
                            <div className="img w-[80px] h-[80px] rounded-full overflow-hidden">
                              {review.user.avatar.url ? (
                                ...
                                <img
                                  src={
                                    "https://res.cloudinary.com/dllelmzim/image/upload/v1753808261/user_dhgqbt.png"
                                  }
                                  alt=""
                          ...
                          <Rating
                            ...
                            value={review.rating}
                            size={
                              context.windowWidth > 992 ? "medium" : "small"
                            }
                            precision={0.5}
                            readOnly
                          />
                  ...
                  <div className="reviewForm bg-[#f1f1f1] p-4 rounded-md">
                    ...
                    <form className="w-full">
                      ...
                      <Rating
                        value={productRating}
                        size={context.windowWidth > 992 ? "medium" : "small"}
                        precision={0.5}
                      ...
                      <div className="flex items-center mt-5">
                        <Button
                          ...
                          className="!bg-orange-600 !text-white !text-[12px] md:!text-[15px]  min-w-[250px]"
                        >
                          {reviewLoading
                            ? "Submitting Review"
                            : "Submit Review"}
