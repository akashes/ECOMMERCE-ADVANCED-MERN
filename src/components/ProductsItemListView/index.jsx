      ...
      <div className="info p-3 py-5  w-[75%]  px-8 ">
        ...
        <h3 className='text-[18px] title  font-[500] text-[#000] mb-1 mt-3 mb-3'>
            ...
            <p className='text-[14px] mb-3'>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illo ipsa maxime est quas 
              repellendus voluptatum, maiores libero officia necessitatibus explicabo?
            </p>
